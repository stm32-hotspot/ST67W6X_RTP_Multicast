...
#define W6X_NET_DNS_MANUAL                      0

/** String defining DNS IP 1 address to use
  * @note: This address will be used only if W6X_NET_DNS_MANUAL equals 1 */
#define W6X_NET_DNS_IP_1                        {208, 67, 222, 222}

/** String defining DNS IP 2 address to use
  * @note: This address will be used only if W6X_NET_DNS_MANUAL equals 1 */
#define W6X_NET_DNS_IP_2                        {8, 8, 8, 8}

/** String defining DNS IP 3 address to use
  * @note: This address will be used only if W6X_NET_DNS_MANUAL equals 1 */
#define W6X_NET_DNS_IP_3                        {0, 0, 0, 0}
