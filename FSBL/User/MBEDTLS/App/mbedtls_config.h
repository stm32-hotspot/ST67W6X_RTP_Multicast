...
/**
  ...
  * @brief   The mbedTLS custom configuration header file
  ******************************************************************************
  * @attention
  *
...
static inline void *mbedtls_calloc_custom(size_t count, size_t size)
{
...
static inline void mbedtls_free_custom(void *ptr)
{
  if (ptr)
  {
    vPortFree(ptr);
 ...
 */
#define MBEDTLS_PLATFORM_STD_CALLOC        mbedtls_calloc_custom
 ...
 */
#define MBEDTLS_PLATFORM_STD_FREE            mbedtls_free_custom
