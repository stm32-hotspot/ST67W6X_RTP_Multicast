...
static SemaphoreHandle_t BspI2c1Semaphore = 0;
static SemaphoreHandle_t BspI2c2Semaphore = 0;
...
int32_t BSP_I2C1_Init(void)
{
  ...
  if (I2c1InitCounter == 0U)
  {
    ...
    {
#if defined(BSP_USE_CMSIS_OS)
      if (BspI2c1Semaphore == NULL)
      {
        /* Create semaphore to prevent multiple I2C access */
    	  BspI2c1Semaphore = xSemaphoreCreateMutex();
      }
#endif /* BSP_USE_CMSIS_OS */
...
int32_t BSP_I2C1_WriteReg(uint16_t DevAddr, uint16_t Reg, uint8_t *pData, uint16_t Length)
{
  ...
  xSemaphoreTake(BspI2c1Semaphore, portMAX_DELAY);
#endif /* BSP_USE_CMSIS_OS */
  ...
  xSemaphoreGive(BspI2c1Semaphore);
#endif /* BSP_USE_CMSIS_OS */
  return ret;
}
...
int32_t BSP_I2C2_Init(void)
{
  ...
  if (I2c2InitCounter == 0U)
  {
    ...
    {
#if defined(BSP_USE_CMSIS_OS)
      if (BspI2c2Semaphore == NULL)
      {
        /* Create semaphore to prevent multiple I2C access */
        BspI2c2Semaphore = xSemaphoreCreateMutex();
      }
#endif /* BSP_USE_CMSIS_OS */
#if (USE_HAL_I2C_REGISTER_CALLBACKS == 0)
      /* Init the I2C2 Msp */
...
#if defined(BSP_USE_CMSIS_OS)
  /* Get semaphore to prevent multiple I2C access */
  xSemaphoreTake(BspI2c2Semaphore, portMAX_DELAY);
#endif /* BSP_USE_CMSIS_OS */
...
#if defined(BSP_USE_CMSIS_OS)
  /* Release semaphore to prevent multiple I2C access */
  xSemaphoreGive(BspI2c2Semaphore);
#endif /* BSP_USE_CMSIS_OS */
  return ret;
}
