		...
		VL53L5CX_Configuration		*p_dev)
{
	...
	status |= VL53L5CX_WrMulti(&(p_dev->platform),0, (uint8_t*)&VL53L5CX_FIRMWARE[0],0x8000);
	status |= VL53L5CX_WrByte(&(p_dev->platform), 0x7fff, 0x0a);
	status |= VL53L5CX_WrMulti(&(p_dev->platform),0, (uint8_t*)&VL53L5CX_FIRMWARE[0x8000],0x8000);
	status |= VL53L5CX_WrByte(&(p_dev->platform), 0x7fff, 0x0b);
	status |= VL53L5CX_WrMulti(&(p_dev->platform),0, (uint8_t*)&VL53L5CX_FIRMWARE[0x10000],0x5000);
	status |= VL53L5CX_WrByte(&(p_dev->platform), 0x7fff, 0x01);
